    ...
    public class EmailServiceController : ControllerBase
    {
        ...
        public IActionResult sendEmail(EmailRequestdto emailRequestdto)
        {
            ...
            try
            {
                ...
                MailAddress address = new MailAddress("support@merobolee.com");  
                msgs.From = address;  
                msgs.Subject = "Register";
                msgs.Body = HtmlContent;  
                ...
                client.Credentials = new System.Net.NetworkCredential("support@merobolee.com", "K@thmandu2503");  
                //Send the msgs  
                client.Send(msgs);  
