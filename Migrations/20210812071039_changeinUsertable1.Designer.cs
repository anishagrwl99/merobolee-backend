...
namespace MeroBolee.Migrations
{
    ...
    [Migration("20210812071039_changeinUsertable1")]
    partial class changeinUsertable1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeroBolee.Model.UserExperienceDocEntity", b =>
                {
                    ...
                    b.Property<int?>("UserEntityUser_Id")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserEntityUser_Id");
            ...
            modelBuilder.Entity("MeroBolee.Model.UserExperienceDocEntity", b =>
                {
                    b.HasOne("MeroBolee.Model.UserEntity", null)
                        .WithMany("Experienced_document")
                        .HasForeignKey("UserEntityUser_Id");
                });
