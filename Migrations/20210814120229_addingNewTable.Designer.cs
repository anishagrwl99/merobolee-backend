...
namespace MeroBolee.Migrations
{
    ...
    [Migration("20210814120229_addingNewTable")]
            ...
            modelBuilder.Entity("MeroBolee.Model.TenderEntity", b =>
                {
                    ...
                    b.Property<int?>("PublishStatusStatus_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Payment_Status_Id");

                    b.HasIndex("Posted_By");

                    b.HasIndex("PublishStatusStatus_id");
            ...
            modelBuilder.Entity("MeroBolee.Model.TenderEntity", b =>
                {
                    ...
                    b.HasOne("MeroBolee.Model.PaymentStatusEntity", "PaymentStatusEntity")
                        .WithMany()
                        .HasForeignKey("Payment_Status_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("MeroBolee.Model.PublishStatus", "PublishStatus")
                        .WithMany()
                        .HasForeignKey("PublishStatusStatus_id");
