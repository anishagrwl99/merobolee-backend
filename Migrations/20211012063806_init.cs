    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_lk_category", x => x.category_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    tender_id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    tender_code = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "Tourism", new DateTime(2021, 10, 12, 12, 23, 6, 458, DateTimeKind.Local).AddTicks(3923), new DateTime(2021, 10, 12, 12, 23, 6, 458, DateTimeKind.Local).AddTicks(3926) },
                    { 1, "Transportation", new DateTime(2021, 10, 12, 12, 23, 6, 458, DateTimeKind.Local).AddTicks(3874), new DateTime(2021, 10, 12, 12, 23, 6, 458, DateTimeKind.Local).AddTicks(3898) },
                    { 2, "Construction", new DateTime(2021, 10, 12, 12, 23, 6, 458, DateTimeKind.Local).AddTicks(3911), new DateTime(2021, 10, 12, 12, 23, 6, 458, DateTimeKind.Local).AddTicks(3914) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "NP", "NEP", "Nepal", new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(806), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(810) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(6653), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(6659), "Super Admin" },
                    { 2, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(6661), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(6663), "Bid Inviter" },
                    { 3, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(6664), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(6665), "Bidder" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Transportation", new DateTime(2021, 10, 12, 12, 23, 6, 429, DateTimeKind.Local).AddTicks(7461), new DateTime(2021, 10, 12, 12, 23, 6, 429, DateTimeKind.Local).AddTicks(7486), 1 },
                    { 2, "Construction", new DateTime(2021, 10, 12, 12, 23, 6, 429, DateTimeKind.Local).AddTicks(7517), new DateTime(2021, 10, 12, 12, 23, 6, 429, DateTimeKind.Local).AddTicks(7521), 1 },
                    { 3, "Tourism", new DateTime(2021, 10, 12, 12, 23, 6, 429, DateTimeKind.Local).AddTicks(7534), new DateTime(2021, 10, 12, 12, 23, 6, 429, DateTimeKind.Local).AddTicks(7537), 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 10, 12, 12, 23, 5, 995, DateTimeKind.Local).AddTicks(991), new DateTime(2021, 10, 12, 12, 23, 5, 995, DateTimeKind.Local).AddTicks(8806), 0f, 1, "Year", "Registration", 2000f, 1 },
                    { 2, new DateTime(2021, 10, 12, 12, 23, 5, 995, DateTimeKind.Local).AddTicks(9275), new DateTime(2021, 10, 12, 12, 23, 5, 995, DateTimeKind.Local).AddTicks(9280), 0f, 1, "Year", "Add New Company", 1500f, 1 },
                    { 3, new DateTime(2021, 10, 12, 12, 23, 5, 995, DateTimeKind.Local).AddTicks(9283), new DateTime(2021, 10, 12, 12, 23, 5, 995, DateTimeKind.Local).AddTicks(9284), 0f, 1, "Year", "Renew", 1000f, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1959), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1963), "Province No. 1" },
                    { 2, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1967), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1968), "Province No. 2" },
                    { 3, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1969), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1970), "Bagmati Province" },
                    { 4, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1972), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1973), "Gandaki Province" },
                    { 5, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1975), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1976), "Lumbini Province" },
                    { 6, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1977), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1978), "Karnali Province" },
                    { 7, 1, new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1980), new DateTime(2021, 10, 12, 12, 23, 5, 996, DateTimeKind.Local).AddTicks(1981), "Sudurpashchim Province" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, null, new DateTime(2021, 10, 12, 12, 23, 6, 0, DateTimeKind.Local).AddTicks(6440), new DateTime(2021, 10, 12, 12, 23, 6, 0, DateTimeKind.Local).AddTicks(6462), null, null, "Super", "Admin", null, "YHCTM7byxNlmg1x9CGp5nA==", "super.admin@test.com", 1, 2, null },
                    { 2L, null, new DateTime(2021, 10, 12, 12, 23, 6, 3, DateTimeKind.Local).AddTicks(8386), new DateTime(2021, 10, 12, 12, 23, 6, 3, DateTimeKind.Local).AddTicks(8405), null, null, "Bid", "Inviter", null, "YHCTM7byxNlmg1x9CGp5nA==", "bid.inviter@test.com", 2, 2, null },
                    { 3L, null, new DateTime(2021, 10, 12, 12, 23, 6, 3, DateTimeKind.Local).AddTicks(8735), new DateTime(2021, 10, 12, 12, 23, 6, 3, DateTimeKind.Local).AddTicks(8738), null, null, "Bid", "Bidder", null, "YHCTM7byxNlmg1x9CGp5nA==", "bid.bidder@test.com", 3, 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "Address1", "Address2", "Address3", "Kathmandu", null, null, null, 1, 1, "Test Company", null, null, 3, "SP102112122305996", "Bidder,BidInviter", "123" });
