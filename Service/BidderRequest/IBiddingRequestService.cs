...
namespace MeroBolee.Service
{
    public interface IBiddingRequestService
    {
        ...
        Task<List<FinalPositionResponseDto>> GetFinalSealBiddingPosition(long tenderId);

        Task<FinalPositionResponseDto> GetFinalBiddingPositionForBidder(long tenderId, long userId);
        Task<FinalPositionResponseDto> GetFinalSealBiddingPositionForBidder(long tenderId, long userId);
