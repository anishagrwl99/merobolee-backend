...
namespace MeroBolee.Service
{
    public interface IUserService
    {
        ...
        Task<IEnumerable<GetUserDto>> GetUser(long companyId, string baseUrl, string defaultImage);
        Task<IEnumerable<GetUserDto>> GetAllUser(string baseUrl, string defaultImage);
        ...
        Task<long> ChangeUserStatus(ChangeUserStatusDto dto);
